...
## [0.7.0](https://github.com/remloyal/farm/compare/farmfe_core-v0.6.4...farmfe_core-v0.7.0) - 2024-10-22

### Added

- *(css)* support css module name coversion ([#1784](https://github.com/remloyal/farm/pull/1784))
- support resolve dedupe ([#1762](https://github.com/remloyal/farm/pull/1762))
...
- preset_env plugin match and module system `analyze` ([#1751](https://github.com/remloyal/farm/pull/1751))
...
- revert change of replacing invalid css ([#1831](https://github.com/remloyal/farm/pull/1831))
