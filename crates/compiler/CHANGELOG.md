...
## [0.0.17](https://github.com/remloyal/farm/compare/farmfe_compiler-v0.0.16...farmfe_compiler-v0.0.17) - 2025-05-01

### Added

- *(hmr)* support calling compiler.update to compile a full new module ([#2119](https://github.com/remloyal/farm/pull/2119))

### Fixed

- cjs node export order ([#2149](https://github.com/remloyal/farm/pull/2149))
- assign reference treeshake ([#2141](https://github.com/remloyal/farm/pull/2141))
- *(hmr)* panic when call compiler.update for a full new module multi… ([#2120](https://github.com/remloyal/farm/pull/2120))
- #2103 and resource pot id hash conflicts ([#2107](https://github.com/remloyal/farm/pull/2107))
- persistent cache panic when using addFileWatchFile with query #2067 ([#2068](https://github.com/remloyal/farm/pull/2068))
